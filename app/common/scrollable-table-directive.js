...
(function(){
    ...
    var controller = function($scope, $element, $timeout, $q, $parse){
...
//			// periodically
    ...
    var ramScrollableTable = function(){
        return {
            transclude: true,
            restrict: 'A',
            scope: {
    ...
    ramAngularApp.module.directive('ramScrollableTable', ramScrollableTable);
})();